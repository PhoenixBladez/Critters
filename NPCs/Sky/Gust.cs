...
namespace Critters.NPCs.Sky
{
    public class Gust : ModNPC
    {
        ...
        public override void SetDefaults()
        {
			...
			npc.catchItem = (short)mod.ItemType("GustItem");
			banner = npc.type;
			bannerItem = mod.ItemType("GustBanner");
            npc.height = 34;
			npc.damage = 0;
			npc.npcSlots = 0;
			...
			if (npc.life <= 0)
			{
				...
				for (int num621 = 0; num621 < 20; num621++)
				{
					...
					if (Main.rand.Next(2) == 0)
					{
						...
						Main.dust[num622].fadeIn = 1f + (float)Main.rand.Next(10) * 0.23f;
					}
				}
			}
		}
		...
		{
			return spawnInfo.sky ? 0.081f : 0f;
		}
