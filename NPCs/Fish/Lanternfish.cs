...
namespace Critters.NPCs.Fish
{
	public class Lanternfish : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			npc.catchItem = (short)mod.ItemType("LanternfishItem");
				banner = npc.type;
			bannerItem = mod.ItemType("LanternfishBanner");
        ...
        {
            CrittersUtility.DrawNPCGlowMask(spriteBatch, npc, ModContent.GetTexture("Critters/NPCs/Masks/Lanternfish_Glow"));
        }
		...
		public override void NPCLoot()
		{
			...
			{
				Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, ItemID.StickyGlowstick);
			}
