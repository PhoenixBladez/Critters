...
{
	public class BabySlimeSand : ModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			npc.catchItem = (short)mod.ItemType("BabySlimeSand");
			...
			banner = npc.type;
			bannerItem = mod.ItemType("SandBannerItem");
		}
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			if (npc.life <= 0)
			{
				...
				for (int num621 = 0; num621 < 10; num621++)
				{
					...
					Main.dust[num622].velocity *= .8f;
					{
						Main.dust[num622].scale = 0.02f;
